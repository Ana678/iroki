                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body" style="margin: 10px;">
                                ...
                                @foreach($familyMembers as $familyMember)
                                    @if($familyMember->id != $sessao->id)
                                        <form method="POST" action="editarMembro/{{$familyMember->id}}">
                                            @csrf
                                                        ...
                                                        >
                                                            <label class="col-form-label" for="userphoto">
                                                                <img    class="rounded-circle"
                                                                        @if(@isset($familyMember->profile_photo_path))
                                                                            src="assets/img/avatars/{{$familyMember->profile_photo_path}}"
                                                                        @else
                                                                            src="assets/img/avatars/avatarPadrao.jpeg";
                                                                        @endif
                                                                        width="25" 
