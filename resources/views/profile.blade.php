                                ...
                                <form>
                                    <div class="form-row" style="margin: 6px -5px;">
                                        ...
                                        <div class="col-lg-6 offset-lg-5 text-center mx-auto">
                                            ...
                                            <button class="btn btn-primary btn-sm" type="submit" style="margin: 7px 20px;padding: 2px 6px;background: #e75c25;border-color: #e75c25;">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" class="bi bi-person-dash" style="font-size: 12px;">
