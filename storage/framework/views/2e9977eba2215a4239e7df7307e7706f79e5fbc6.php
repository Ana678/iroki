                        ...
                        <div class="p-5">
                            <div class="text-center">
                                <h4 class="text-dark mb-4" style="color: rgb(90, 92, 105);">
                                    ...
                                    <?php else: ?>
                                        Editando <?php echo e($user->name); ?>

                                    <?php endif; ?>
                                </h4>
                            </div>
                            <form class="user" action="../editandoMembro/<?php echo e($user->id); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <label class="btn btn-primary btn-block text-white btn-user" style="background: rgba(231,92,37,0.77);border-color: #E75C25;">
                                            Selecionar
                                            <input class="d-none" type="file" name="image" value="/assets/img/avatars/<?php echo e($user->profile_photo_path); ?>">
                                        </label>
                                    </div>
                                </div>
                                <hr>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\iroki\resources\views/editarMembro.blade.php ENDPATH**/ ?>