                    ...
                    <div class="col">
                        <div class="p-5">
                            <div class="text-center">
                                <h4 class="text-dark mb-4" style="color: rgb(90, 92, 105);">Olá <?php echo e($sessao->name); ?>, seja muito bem vindo(a) ao iroki!</h4>
                            </div>
                            <form class="user">
...
<?php echo $__env->make('layouts.loginLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\iroki\resources\views/login/primeiroLogin.blade.php ENDPATH**/ ?>