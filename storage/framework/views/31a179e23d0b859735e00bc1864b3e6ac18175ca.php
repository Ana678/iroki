                ...
                <div class="card shadow mb-4 align-items-center">
                    <div class="card-body text-center">
                        <?php if(@isset($family->family_photo_path)): ?>
                            <img class="img-no-padding img-responsive img-fluid" src="assets/img/family/<?php echo e($family->family_photo_path); ?>">    
                        <?php else: ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\iroki\resources\views//dashboard.blade.php ENDPATH**/ ?>