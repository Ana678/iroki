                        ...
                        <div class="p-5">
                            ...
                            <form class="user">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6"><button class="btn btn-primary btn-block text-white btn-user" type="file" style="background: rgba(231,92,37,0.77);border-color: #E75C25;">Selecionar<br></button></div>
                                </div><a href="validacao.html"><button class="btn btn-primary btn-block text-white btn-user" type="submit" style="background: #E75C25;border-color: #E75C25;">Registar Conta<br></button></a>
                                <hr>
                            </form>
                            ...
                            <div class="text-center"><a class="small" href="login.html" style="color: #68aea1;">Já tem uma conta? Conecte-se!<br><br></a></div>
                        </div>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\iroki\resources\views/cadastro.blade.php ENDPATH**/ ?>