                ...
                <div class="row">
                    <div class="col">
                        <div class="p-5">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input class="btn btn-primary btn-block text-white btn-user" 
                                                ...
                                                name="quantMembros"
                                                value="Registrar Este e Outro Membro"
                                        >
                                    </div>
                                    <div class="col-sm-6">
                                        <input class="btn btn-primary btn-block text-white btn-user" 
                                                ...
                                                style="background: #e75c25;border-color: #e75c25;border-top-color: rgb(255,;border-right-color: 255,;border-bottom-color: 255);border-left-color: 255,;"
                                                name="quantMembros"
                                                value="Registar Apenas Este Membro"
                                        >
                                    </div>
                                </div>
                                <hr>
                            ...
                            <div class="text-center">
                                <a class="small" href="/profile" style="color: #68aea1;">
                                    <br>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\iroki\resources\views/cadastroMembro.blade.php ENDPATH**/ ?>