                ...
                <div class="card mb-3">
                    <div class="card-body text-center shadow">
                        <img class="rounded-circle mb-3 mt-4" 
                            <?php if(@isset($sessao->profile_photo_path)): ?>
                                src="assets/img/avatars/<?php echo e($sessao->profile_photo_path); ?>" 
                            <?php else: ?>
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="username-1" placeholder="John" name="name" value="<?php echo e($sessao->name); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="email" id="email" placeholder="user@example.com" name="email" value="<?php echo e($sessao->email); ?>">
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="card align-items-center" style="border-color: transparent;background: transparent;">
                    <div class="card-body text-center shadow">
                        <?php if(@isset($family->family_photo_path)): ?>
                            <img class="mb-3 mt-4 img-no-padding img-responsive img-fluid" src="assets/img/family/<?php echo e($family->family_photo_path); ?>">    
                        <?php else: ?>
                    ...
                    <div class="col-lg-12 col-xl-12">
                        <div class="card shadow">
                            ...
                            <div class="card-body" style="margin: 10px;">
                                <!--Início da listagem-->
                                <?php $__currentLoopData = $familyMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $familyMember): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($familyMember->id != $sessao->id): ?>
                                        <form method="POST" action="editarMembro/<?php echo e($familyMember->id); ?>">
                                            <?php echo csrf_field(); ?>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        >
                                                            <label class="col-form-label" for="userphoto">
                                                                <img    class="rounded-circle"
                                                                        <?php if(@isset($familyMember->profile_photo_path)): ?>
                                                                            src="assets/img/avatars/<?php echo e($familyMember->profile_photo_path); ?>"
                                                                        <?php else: ?>
                                                                            src="assets/img/avatars/avatarPadrao.jpeg";
                                                                        <?php endif; ?>
                                                                        width="25" 
                                                        ...
                                                        >
                                                            <label class="col-form-label" for="username">
                                                                <strong><?php echo e($familyMember->name); ?></strong>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php if($sessao->master == 1): ?>
                                                    <div class="col-lg-6 offset-lg-5 text-center mx-auto">
                                                        <button class="btn btn-primary btn-sm" 
                                                                ...
                                                                name="edit"
                                                                value="edit"
                                                                style="margin: 7px 20px;padding: 2px 6px;background: #e75c25;border-color: #e75c25;"
                                                        >
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\iroki\resources\views/profile.blade.php ENDPATH**/ ?>