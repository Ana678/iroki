...
class PasswordResetLinkController extends Controller
{
    ...
    public function store(Request $request): Responsable{
            ...
            if(isset($user->master) && $user->master == 0){
                return app(FailedPasswordResetLinkRequestResponse::class, ['status' => 'Só o responsável pela família pode alterar a senha desse usuário!']);   
            }
